...
def test_b(capsys):
    ...
    b_todo.print_linked_list(node0)
...
def test_c():
    ...
    new_head = c_tedious_work.remove(node0, 1)
...
@pytest.mark.parametrize(
    'func', (d_caring_mother.find, d_caring_mother.find_iter)
)
def test_d(func):
...
def test_e():
    ...
    new_head = e_reversed.reverse(node0)
